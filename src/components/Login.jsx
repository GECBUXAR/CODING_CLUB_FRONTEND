...
//   return (
//     <div className="min-h-screen w-full flex items-center justify-center p-4 sm:p-6 bg-gray-50">
//       <div
//         ref={containerRef}
...
//           <div
//             ref={leftSectionRef}
//             className="hidden md:block relative bg-gradient-to-br from-violet-600 via-fuchsia-600 to-indigo-600 p-8 lg:p-12 text-white md:w-[45%] lg:w-[55%] overflow-hidden"
//           >
...
//                 <h1
//                   ref={taglineRef}
//                   className="text-3xl sm:text-4xl lg:text-5xl font-black uppercase tracking-wide text-white leading-tight"
//                 >
//                   WELCOME BACK
//                 </h1>
//               </div>
...
//               {/* Description text - uncomment if needed */}
//               {/* <p
//                 ref={descriptionRef}
//                 className="text-sm lg:text-lg text-white/90 font-medium mt-4"
//               >
...
//           <div className="flex flex-col p-4 sm:p-6 md:p-8 lg:p-12 w-full md:w-[55%] lg:w-[45%]">
...
//               />
//               <h2 className="text-xl sm:text-2xl font-bold text-center bg-gradient-to-r from-violet-600 to-fuchsia-600 bg-clip-text text-transparent">
//                 Cosmic Connect
//               </h2>
//             </div>

//             <ThreeDCard className="mx-auto w-full max-w-md space-y-4 sm:space-y-6 md:space-y-8">
//               <div>
//                 <h2 className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-fuchsia-600 to-pink-600 bg-clip-text text-transparent mb-2 sm:mb-3">
//                   Sign In
//                 </h2>
...
//                       className="h-10 sm:h-12 md:h-14 w-full rounded-xl border-2 border-gray-200 bg-white pl-10 sm:pl-12 pr-4 text-sm sm:text-md md:text-lg transition-all focus:outline-none"
//                     />
//                   </div>
...
//                       onFocus={inputFocusEffect}
//                       onBlur={inputBlurEffect}
//                       className="h-10 sm:h-12 md:h-14 w-full rounded-xl border-2 border-gray-200 bg-white pl-10 sm:pl-12 pr-10 sm:pr-12 text-sm sm:text-md md:text-lg transition-all focus:outline-none"
//                     />
//                     <button
//                       type="button"
//                       onClick={() => setIsPasswordVisible(!isPasswordVisible)}
//                       className="absolute inset-y-0 right-0 flex items-center pr-3 sm:pr-4 text-gray-500"
//                     >
//                       {isPasswordVisible ? (
...
//                         className="h-3 w-3 sm:h-4 sm:w-4 rounded border-gray-300 text-fuchsia-600 focus:ring-fuchsia-500"
//                       />
//                       <Label
//                         htmlFor="remember-me"
...
//                     <Link
//                       to="/forgot-password"
//                       className="text-xs sm:text-sm font-medium text-fuchsia-600 hover:text-fuchsia-700"
//                     >
//                       Forgot password?
//                     </Link>
//                   </div>
...
//                   className={cn(
//                     "h-10 sm:h-12 md:h-14 w-full rounded-xl bg-gradient-to-r from-violet-600 via-fuchsia-600 to-pink-600",
//                     "text-sm sm:text-md md:text-lg font-semibold text-white shadow-lg transition-all hover:shadow-xl",
...
//                   onMouseEnter={buttonHoverEffect}
//                   onMouseLeave={buttonHoverEndEffect}
//                   className="flex h-9 sm:h-10 md:h-12 items-center justify-center gap-2 rounded-xl border-2 border-gray-200 bg-white text-gray-700 transition-all hover:border-rose-200 hover:bg-rose-50"
//                 >
...
//                   onMouseEnter={buttonHoverEffect}
//                   onMouseLeave={buttonHoverEndEffect}
//                   className="flex h-9 sm:h-10 md:h-12 items-center justify-center gap-2 rounded-xl border-2 border-gray-200 bg-white text-gray-700 transition-all hover:border-blue-200 hover:bg-blue-50"
//                 >
...
//                   onMouseEnter={buttonHoverEffect}
//                   onMouseLeave={buttonHoverEndEffect}
//                   className="flex h-9 sm:h-10 md:h-12 items-center justify-center gap-2 rounded-xl border-2 border-gray-200 bg-white text-gray-700 transition-all hover:border-black hover:bg-gray-50"
//                 >
//                   <Linkedin className="h-4 w-4 sm:h-5 sm:w-5 text-[#0A66C2]" />
//                 </Button>
//               </div>

//               <p className="text-center text-xs text-gray-500 mt-4 sm:mt-6 md:mt-8">
        ...
        <div className="flex flex-col gap-0 md:flex-row">
          ...
          >
            ...
            <div className="relative z-10 px-2 pl-8 space-y-4 max-w-lg">
              ...
              {/* <p
                ref={descriptionRef}
                className="text-lg text-white/90 font-medium mt-4 ml-8"
              >
                Sign in to access your premium resources, saved projects, and
                connect with our creative community.
              </p> */}
