...
const Login = () => {
  ...
  useGSAP(() => {
    ...
    // Form animation with staggered entries
    gsap.fromTo(
    ...
    <div className="min-h-screen md:min-h-0 flex items-center justify-center p-4 md:p-6 lg:p-8 bg-gray-50">
      ...
      >
        <div className="flex flex-col md:flex-row">
          ...
          <div
            ref={leftSectionRef}
            className="relative bg-gradient-to-br from-violet-600 via-fuchsia-600 to-indigo-600 p-8 md:p-12 text-white md:w-1/2 overflow-hidden"
          >
            ...
            <ThreeDCard className="mx-auto w-full max-w-md space-y-8">
              ...
              <form ref={formRef} className="space-y-5" onSubmit={handleSubmit}>
                ...
                <Button
                  ...
                  className={cn(
                    "h-14 w-full rounded-xl bg-gradient-to-r from-violet-600 via-fuchsia-600 to-pink-600",
